...
var CacheBusterID = "1";
var MobileWebGames = [412,200,344,384,273,278,270,275,261,266,474,390,303,467,570,495,413,457,58,359,292,360,371,138,345,228,294,491];
...
function loadGamecss()
{
    ...
    if(env.toLowerCase() == "w" && !isMobileForWebGame)
    {
        resolution = "1280x755";
    }
