...
function $addExponent(this$static, digits){
  ...
  $append_0(digits.data_0, exponentDigits);
}
...
function $adjustFractionDigits(this$static, digits){
  ...
  if (this$static.digitsLength < requiredDigits) {
    ...
    while (toRemove > requiredDigits && $charAt($toString_0(digits.data_0), toRemove - 1) == 48) {
      --toRemove;
    }
...
function $computeExponent(this$static, digits){
  var remainder, strip;
  strip = 0;
  while (strip < this$static.digitsLength - 1 && $charAt($toString_0(digits.data_0), strip) == 48) {
    ++strip;
  }
  if (strip > 0) {
  ...
  if (this$static.digitsLength == 1 && $toString_0(digits.data_0).charCodeAt(0) == 48) {
...
function $format(this$static, number){
  ...
  if (!isFinite(number)) {
    ...
    return $toString_0(buf.data_0);
  }
  number *= this$static.multiplier;
  scale = toScaledString(buf, number);
  preRound = $toString_0(buf.data_0).length + scale + this$static.maximumFractionDigits + 3;
  if (preRound > 0 && preRound < $toString_0(buf.data_0).length && $charAt($toString_0(buf.data_0), preRound) == 57) {
    $propagateCarry(this$static, buf, preRound - 1);
    scale += $toString_0(buf.data_0).length - preRound;
    $replace_2(buf, preRound, $toString_0(buf.data_0).length, '');
  }
  this$static.exponent = 0;
  this$static.digitsLength = $toString_0(buf.data_0).length;
...
function $parseAffix(this$static, pattern, start, affix, inNegativePattern){
  ...
  $replace_1(affix, $toString_0(affix.data_0).length);
  inQuote = false;
  len = pattern.length;
      ...
      switch (ch) {
        ...
        case 164:
          ...
          if (pos + 1 < len && pattern.charCodeAt(pos + 1) == 164) {
            ++pos;
            $append_4(affix, this$static.currencyCode);
          }
           else {
            $append_4(affix, this$static.currencySymbol);
          }
...
function $processLeadingZeros(this$static, digits){
  ...
  if (!this$static.useExponentialNotation) {
    if (this$static.decimalPosition < this$static.minimumIntegerDigits) {
      ...
      $insert_3(digits, 0, $toString_0(prefix.data_0));
    }
      ...
      for (i = 0; i < strip; ++i) {
        if ($charAt($toString_0(digits.data_0), i) != 48) {
          strip = i;
          break;
        }
      }
...
function $propagateCarry(this$static, digits, i){
  ...
  carry = true;
  while (carry && i >= 0) {
    digit = $charAt($toString_0(digits.data_0), i);
    if (digit == 57) {
...
function toScaledString(buf, val){
  ...
  startLen = $toString_0(buf.data_0).length;
  $append_6(buf, val.toPrecision(20));
  scale = 0;
  expIdx = $indexOf_1($toString_0(buf.data_0), 'e', startLen);
  expIdx < 0 && (expIdx = $indexOf_1($toString_0(buf.data_0), 'E', startLen));
  if (expIdx >= 0) {
    expDigits = expIdx + 1;
    expDigits < $toString_0(buf.data_0).length && $charAt($toString_0(buf.data_0), expDigits) == 43 && ++expDigits;
    expDigits < $toString_0(buf.data_0).length && (scale = __parseAndValidateInt($substring($toString_0(buf.data_0), expDigits)));
    $replace_2(buf, expIdx, $toString_0(buf.data_0).length, '');
  }
  dot = $indexOf_1($toString_0(buf.data_0), '.', startLen);
  if (dot >= 0) {
    $replace(buf.data_0, dot, dot + 1, '');
    scale -= $toString_0(buf.data_0).length - dot;
  }
  return scale;
}
...
function $replace_1(this$static, end){
  $replace(this$static.data_0, 0, end, '');
  return this$static;
}
...
function $charAt_0(this$static, index){
  return $charAt($toString_0(this$static.data_0), index);
}
...
function $sendResumeGameCommamd(this$static, listener){
  ...
  $append_0(pData.data_0, 'UN');
  $appendNonNull(pData.data_0, '=');
  $append_4(pData, dynamicCast($get_3(($clinit_PlayerDO() , playerInfo), paramsTag[1]), Q$String));
  $appendNonNull(pData.data_0, '-');
  $append_3(pData, $get_3(playerInfo, 'USERNAME'));
  $appendNonNull(pData.data_0, '&');
  ...
  rgrCommand.url = SapiServerSapiPage + '?' + $toString_0(pData.data_0);
      ...
      if ($equals(elementName, 'CARD')) {
        ...
        for (i = 0; i < getLength(playerList.jsObject); ++i) {
          if (!!build(item_0(playerList.jsObject, i)) && instanceOf(build(item_0(playerList.jsObject, i)), Q$Element)) {
            ...
            $equals(playerElementName, 'SNO')?$toString_0(getElementText(playerElement).data_0):$equals(playerElementName, 'ISNO')?$toString_0(getElementText(playerElement).data_0):$equals(playerElementName, 'BTP')?$toString_0(getElementText(playerElement).data_0):$equals(playerElementName, 'BTR')?$toString_0(getElementText(playerElement).data_0):$equals(playerElementName, 'GAV') && $toString_0(getElementText(playerElement).data_0);
          }
        }
      }
        ...
        for (i = 0; i < getLength(customList.jsObject); ++i) {
          if (!!build(item_0(customList.jsObject, i)) && instanceOf(build(item_0(customList.jsObject, i)), Q$Element)) {
            ...
            $toString_0(getElementText(customElement).data_0);
            break;
          }
        }
      }
...
function $toString_4(this$static){
  ...
  $append_6(builder, this$static.fontWeight.getCssName());
  $appendNonNull(builder.data_0, ' ');
  $append_5(builder, this$static.fontSize_0);
  $append_0(builder.data_0, 'px ');
  $append_6(builder, this$static.fontName);
  return $toString_0(builder.data_0);
}
...
function $createBTP(this$static){
  ...
  $append_0(params.data_0, 'BTP');
  $appendNonNull(params.data_0, '=');
  $append_2(params, valueOf_0(__parseAndValidateInt(this$static.numOfTicketsRange_0[this$static.currentNumTicketsIndex])).value_0);
  $appendNonNull(params.data_0, '-');
  $appendNonNull(params.data_0, '=');
  $append_4(params, this$static.betDenominations[this$static.currentBetDenominationIndex]);
  return $toString_0(params.data_0);
}
...
_.onClick = function onClick_9(event_0){
  ...
  this.this$0.infoButton.button.element.blur();
...
_.execute_2 = function execute_44(params){
...
_.execute_2 = function execute_45(params){
...
_.execute_2 = function execute_46(params){
...
_.execute_2 = function execute_47(params){
...
_.execute_2 = function execute_48(params){
...
_.execute_2 = function execute_49(params){
}
;
...
_.execute_2 = function execute_50(params){
...
_.execute_2 = function execute_51(params){
...
_.execute_2 = function execute_52(params){
}
;
...
_.execute_2 = function execute_53(params){
...
function $execute_10(this$static){
  var $e0, e;
  try {
    this$static.execCommand.execute_2(this$static.params);
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, Q$Throwable)) {
...
function $requestAnimationFrame_0(instance){
...
function $setAnimationTimer(this$static){
  if (envType_0 == ($clinit_Constants$CommonGamesConstants$ENVIRONMENT_TYPE() , WEB)) {
    $requestAnimationFrame_0(this$static);
  }
   else {
...
function $updateFrame(this$static){
  ...
  if (this$static.isRunning) {
    ...
    envType_0 == ($clinit_Constants$CommonGamesConstants$ENVIRONMENT_TYPE() , WEB)?$requestAnimationFrame_0(this$static):$schedule_0(this$static.animationTimer, sleepTime);
  }
}
